        ...
        <section className="max-w-7xl mx-auto py-12 md:py-24 border-y border-slate-100 dark:border-navy-800 bg-white dark:bg-navy-950">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center px-6">
                <div className="space-y-2">
                    <h3 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl text-saffron-600 dark:text-saffron-500">50,000+</h3>
                 ...
                 <div className="space-y-2">
                    <h3 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl text-saffron-600 dark:text-saffron-500">95%</h3>
