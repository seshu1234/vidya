...
export function Footer() {
  return (
    <footer className="border-t bg-white dark:bg-navy-950 text-slate-600 dark:text-slate-400">
      <div className="container mx-auto flex flex-col gap-10 py-10 md:flex-row md:py-16 px-6">
        <div className="flex-1 space-y-4">
          <h2 className="font-heading font-bold text-navy-900 dark:text-white text-2xl">NextGovJob</h2>
        ...
        <div className="grid grid-cols-2 gap-10 sm:grid-cols-3 md:gap-12 lg:gap-16">
          <div className="flex flex-col space-y-3">
            <h4 className="font-semibold text-navy-900 dark:text-white">Learn</h4>
          ...
          <div className="flex flex-col space-y-3">
            <h4 className="font-semibold text-navy-900 dark:text-white">Resources</h4>
          ...
          <div className="flex flex-col space-y-3">
            <h4 className="font-semibold text-navy-900 dark:text-white">Company</h4>
      ...
      <div className="container mx-auto border-t border-slate-200 dark:border-navy-800 py-8 flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground gap-4">
