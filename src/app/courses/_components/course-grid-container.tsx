...
export function CourseGridContainer({ initialCourses, categories }: CourseGridContainerProps) {
    ...
    return (
        <div className="flex flex-col gap-12 lg:flex-row">
            ...
            <div className="lg:hidden flex flex-col gap-4">
                <div className="relative">
                    ...
                    <Input 
                        ...
                        className="pl-12 h-12 bg-white text-black rounded-full shadow-md border-slate-200"
                        value={searchTerm}
            ...
            <div className="flex-1">
                {/* Desktop Search (Inside relative header in parent) */}
                <div className="hidden lg:block mb-8">
                    <div className="relative max-w-xl">
                        <Search className="absolute left-4 top-3.5 h-5 w-5 text-muted-foreground" />
                        <Input 
                            placeholder="Search courses (e.g. React, Python, AI)..." 
                            className="pl-12 h-12 bg-white text-black rounded-full shadow-lg border-slate-200 text-base"
                            value={searchTerm}
                            onChange={(e) => setSearchTerm(e.target.value)}
                        />
                    </div>
